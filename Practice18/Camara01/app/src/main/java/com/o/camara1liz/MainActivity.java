...
public class MainActivity extends Activity {
    private final String ruta = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "x";
    ...
    protected void onCreate(Bundle b) {
        ...
        jbn = (Button) findViewById(R.id.button1);
        f.mkdirs();
